            ...
            <div className="grid lg:grid-cols-2 gap-12 p-8 md:p-12">
              <div className="relative">
                <div className="relative overflow-hidden rounded-xl bg-gray-100 group">
                  <img
                    src={product.img_path ? import.meta.env.VITE_URL_IMG+product.id :  "/img/glasses.png"}
                    alt={product.name}
              ...
              <div className="flex flex-col">
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 text-gray-600 font-semibold">({product.rating})</span>
                    </div>
                  </div>
                ...
                <div className="mb-6">
                  <div className="flex items-baseline mb-4">
                    <span className="text-5xl font-bold text-[#1E3A8A]">{product.selling_price}</span>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Crafted from high-quality materials for lasting durability and comfort.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">UV Protection</h3>
                  <p className="text-gray-600">
                    Complete protection against harmful UV rays for your eye health.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Professional Fitting</h3>
                  <p className="text-gray-600">
                    Expert assistance available for perfect fitting and adjustment.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Warranty Coverage</h3>
                  <p className="text-gray-600">
                    Comprehensive warranty for manufacturing defects and quality issues.
                  </p>
                </div>
              </div>
            </div>
